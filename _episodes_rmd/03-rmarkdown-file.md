...
![Add updated image](../fig/02-rmd-template-yaml.png)
...
![Update image (crop or replace to remove date)](../fig/02-rmd-template-text.png)
...
![add / update image (remove outdated yaml)](../fig/02-rmd-template-code.png)
