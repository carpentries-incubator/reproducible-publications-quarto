...
> if you want to learn how to use the source editor (as we call it) please see the following documentation. You will need to know Markdown formatting (specifically R-flavored Markdown)
{: .callout}
