...
>> 
>>  Tips:
>>  - Always check if the template meets the most updated guidelines in the journal website. Since this package is maintained by a community. We advise to to check their GitHub page (https://github.com/rstudio/rticles).
