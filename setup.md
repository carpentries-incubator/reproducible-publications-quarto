...
We will need the following account and software for this workshop:
...
If you already have Rstudio and R installed, please check if you have the most recent Rstudio version and at least R version **4.3**, along with Quarto version **1.3.45** at least. The quarto document will not render without the most updated versions. **The Quarto Package is not the CLI.**
